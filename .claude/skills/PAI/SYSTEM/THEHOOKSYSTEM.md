  ...
  "SessionStart": [
    {
      "hooks": [
        {
          "type": "command",
          "command": "bun .claude/hooks/LoadContext.hook.ts"
        },
        {
          "type": "command",
          "command": "bun .claude/hooks/CheckVersion.hook.ts"
        }
      ]
    }
  ]
  ...
  "SessionEnd": [
    {
      "hooks": [
        {
          "type": "command",
          "command": "bun .claude/hooks/SessionSummary.hook.ts"
        }
      ]
    }
  ]
  ...
  "UserPromptSubmit": [
    {
      "hooks": [
        {
          "type": "command",
          "command": "bun .claude/hooks/ExplicitRatingCapture.hook.ts"
        },
        {
          "type": "command",
          "command": "bun .claude/hooks/ImplicitSentimentCapture.hook.ts"
        },
        {
          "type": "command",
          "command": "bun .claude/hooks/UpdateTabTitle.hook.ts"
        }
      ]
    }
  ]
  ...
  "Stop": [
    {
      "hooks": [
        {
          "type": "command",
          "command": "bun .claude/hooks/StopOrchestrator.hook.ts"
        }
      ]
    }
  ]
  ...
  "SubagentStop": [
    {
      "hooks": [
        {
          "type": "command",
          "command": "bun .claude/hooks/AgentOutputCapture.hook.ts"
        }
      ]
    }
  ]
  ...
  "PreToolUse": [
    {
      ...
      "hooks": [
        {
          "type": "command",
          "command": "bun .claude/hooks/SecurityValidator.hook.ts"
        }
      ]
    },
    {
      ...
      "hooks": [
        {
          "type": "command",
          "command": "bun .claude/hooks/SetQuestionTab.hook.ts"
        }
      ]
    }
  ]
    ...
    "HookEventName": [
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": "bun .claude/hooks/my-hook.ts --arg value"
          }
        ]
      }
    ]
    ...
    "Stop": [
      {
        "hooks": [
          {
            "type": "command",
            "command": "bun .claude/hooks/my-custom-hook.ts"
          }
        ]
      }
    ]
...
grep '"type":"user"' ~/.claude/projects/-Users-*/*.jsonl | head -1 | jq '.type'
...
```json
{
  "Stop": [
    {
      "hooks": [
        { "command": "bun .claude/hooks/StopOrchestrator.hook.ts" }  // Single orchestrator
      ]
    }
  ]
}
